...
Based on the menu screenshot you shared, the right place for this tool is **directly inside the existing Python section of the Tools menu**, not inside a nested submenu or a newly-created section.
...
[UEFN Test Tool] Menu entries registered under the existing Tools > Python section.
```
